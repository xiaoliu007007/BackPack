...
public class DataMngAdapter extends BaseAdapter {
    ...
    public interface ClickListener {
        void onClick(DataMngItem item);
    }

    private ClickListener listener;

    public DataMngAdapter(Context ctx, List<DataMngItem> list) {
        this.ctx = ctx;
        this.list = list;
    }
    ...
    public View getView(final int arg0, View arg1, ViewGroup arg2) {
        ...
        if (arg0 <= list.size()) {
            ...
            ph.item.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    if (listener != null) {
                        listener.onClick(list.get(arg0));
                    }
                }
            });
        }
    ...
    private View createListItemView(ViewGroup parent) {
        ...
        return inflater.inflate(R.layout.data_mng_item, parent, false);
    }
