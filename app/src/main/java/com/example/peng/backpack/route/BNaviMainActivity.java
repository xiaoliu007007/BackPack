package com.example.peng.backpack.route;
...
public class BNaviMainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        double la=Double.valueOf(intent.getStringExtra("end_latitude"));
        double lo=Double.valueOf(intent.getStringExtra("end_longitude"));
        startPt = new LatLng(intent.getDoubleExtra("start_latitude",0.0),intent.getDoubleExtra("start_longitude",0.0));
        endPt = new LatLng(la, lo);
        ...
        /*startPt = new LatLng(39.96381393990006,116.35796238396452);
        endPt = new LatLng(39.963813, 116.357962);*/
    ...
    private void initMapStatus(){
        ...
        builder.target(startPt).zoom(20);
